/**
 * Extension developers must implement and export `getTransformer` function to create an extension.
 *
 * ```typescript
 * import type { GetTransformer } from "https://deno.land/x/fall_core@$MODULE_VERSION/mod.ts";
 *
